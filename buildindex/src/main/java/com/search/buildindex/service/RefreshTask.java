package com.search.buildindex.service;
...
public class RefreshTask {
    ...
    public static class RefreshTaskHolder {

        static RefreshTask refreshTask = new RefreshTask();

    }

    public static RefreshTask getInstance() {
        return RefreshTaskHolder.refreshTask;
    }
